...
<body>
    ...
    %>
                ...
                <form action="PlaceBidServlet" method="post">
                    ...
                    <br>
                    Set Auto-Increment: <input type="number" name="incAmount" min="0.00" step="0.01" required><br>
                    Set Auto-Increment Limit: <input type="number" name="autoLimit" min="0.00" step="0.01" required><br>
                    Bid Amount: <input type="number" name="bidAmount" min="<%= auction.getCurrentBid() + auction.getBidIncrement() %>" step="0.01" required><br>
