...
public class Auction {
    ...
    public Auction(String title, double startingPrice, Timestamp closingTime) {
        this.title = title;
    ...
    public Auction(int auctionId, int itemId, int sellerId, String title, String description, double startingPrice, double currentBid, int currentBidUserId, Timestamp startingTime, Timestamp closingTime, String status) {
    ...
    public void setAuctionmId(int auctionId) {
        this.auctionId = auctionId;
    }
